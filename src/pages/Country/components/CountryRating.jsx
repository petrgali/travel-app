...
const CountryRating = ({ nameEN, capitalEN, t }) => {
    ...
    const canRate = () =>
        ...
        !rating.rates.find((rate) => rate.user.username === userState.username)
                ...
                <DialogContent className={classes.dialogContent} dividers>
                    {rating.rates.map((rate) => (
                        <div className={classes.rating}>
                            {rate.user.avatar && (
                                <Avatar
                                    src={`data:image/jpeg;base64,${rate.user.avatar}`}
                                />
                            )}
                            {!rate.user.avatar && (
...
export default withNamespaces()(CountryRating)
